...
class LancementDepartCadence extends Component {
    constructor(props) {
        super(props);
    ...
    pageSuivante() {
        if (this.props.route.params.page === 1) {
            fetch(urlBase + '/allumer/feux/gaucheRouge').then(donnees => {
                ...
                this.props.navigation.push('LancementDepartCadence', { headerTitle: 'Départ cadencé', texte: 'Durée des feux rouges :', page: 2, temps: this.props.route.params.tempsFeuxRouges, tempsAvantDepart: this.props.route.params.temps, tempsFeuxVert: this.props.route.params.tempsFeuxVert, tempsProchainDepart: this.props.route.params.tempsProchainDepart });
            });
            ...
            fetch(urlBase + '/extinction/feux').then(donnees => {
                fetch(urlBase + '/allumer/feux/vert').then(donnees => {
                    this.props.navigation.push('LancementDepartCadence', { headerTitle: 'Départ cadencé', texte: 'Durée des feux verts :', page: 3, temps: this.props.route.params.tempsFeuxVert, tempsAvantDepart: this.props.route.params.tempsAvantDepart, tempsFeuxRouges: this.props.route.params.temps, tempsProchainDepart: this.props.route.params.tempsProchainDepart });
                });
            });
        } else if (this.props.route.params.page === 3) {
            fetch(urlBase + '/extinction/feux').then(donnees => {
                this.props.navigation.push('LancementDepartCadence', { headerTitle: 'Départ cadencé', texte: 'Durée avant le prochain départ :', page: 4, temps: this.props.route.params.tempsProchainDepart, tempsAvantDepart: this.props.route.params.tempsAvantDepart, tempsFeuxRouges: this.props.route.params.tempsFeuxRouges, tempsFeuxVert: this.props.route.params.temps });
            });
        } else if (this.props.route.params.page === 4) {
            this.props.navigation.push('LancementDepartCadence', { headerTitle: 'Départ cadencé', texte: 'Durée avant le départ :', page: 1, temps: this.props.route.params.tempsAvantDepart, tempsFeuxRouges: this.props.route.params.tempsFeuxRouges, tempsFeuxVert: this.props.route.params.tempsFeuxVert, tempsProchainDepart: this.props.route.params.temps });
        }
    }
...
export default LancementDepartCadence;