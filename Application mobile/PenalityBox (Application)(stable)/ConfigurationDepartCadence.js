...
class ConfigurationDepartCadence extends Component {
    constructor(props) {
        super(props);
    ...
    pageSuivante() {
        ...
        if (this.state.heures === '' || this.state.minutes === '' || this.state.secondes === '') {
            ...
            setTimeout(() => {
                let departCadence = {
                    dureeEntreDepart: this.conversionMillisecondes(this.state.formatTemps.exec(tempsTotal))
                };

                MMKV.setArray('DépartCadence', [departCadence]);
...
export default ConfigurationDepartCadence;